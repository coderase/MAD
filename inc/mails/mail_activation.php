...
$to = $email;
$object = 'Activate your MAD Account';
...
$phpmailerInitAction = function(&$phpmailer) {
  ...
  $phpmailer->AddEmbeddedImage(PLUGIN_MAD_DIRECTORY.'img/banner_mail.png', 'banner');
    ...
    <tr bgcolor="#FFF">
      <td class="pattern" width="600" align="center" bgcolor="#FFF">
        <table cellpadding="10" cellspacing="0">
          ...
          <tr>
            <td>
              You\'re almost there! Please click this link to activate your account.
            </td>
          </tr>
          ...
          <tr>
            <td>
              <a href="'.esc_url(home_url()).'/activate/?code='.base64_encode($user_id).'"><img src="cid:button" style="width: 150px !important;"/></a>
            </td>
          </tr>
          ...
          <tr>
            <td>
              If you did not recently attempt to activate your MAD account please disregard this email.
            </td>
          </tr>
