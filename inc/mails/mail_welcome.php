...
$to = $email;
$object = 'Welcome to MAD, '.$first_name.' !';
...
$phpmailerInitAction = function(&$phpmailer) {
  ...
  $phpmailer->AddEmbeddedImage(PLUGIN_MAD_DIRECTORY.'img/welcome_mail.png', 'banner');
  $phpmailer->AddEmbeddedImage(PLUGIN_MAD_DIRECTORY.'img/col1_mail.png', 'col1');
  $phpmailer->AddEmbeddedImage(PLUGIN_MAD_DIRECTORY.'img/col2_mail.png', 'col2');
  $phpmailer->AddEmbeddedImage(PLUGIN_MAD_DIRECTORY.'img/col3_mail.png', 'col3');
  $phpmailer->AddEmbeddedImage(PLUGIN_MAD_DIRECTORY.'img/cta_discover.png', 'cta1');
  $phpmailer->AddEmbeddedImage(PLUGIN_MAD_DIRECTORY.'img/cta_vote.png', 'cta2');
  $phpmailer->AddEmbeddedImage(PLUGIN_MAD_DIRECTORY.'img/cta_buy.png', 'cta3');
    ...
    <tr bgcolor="#FFF">
      <td class="pattern" width="500" align="center" bgcolor="#FFF">
        <table cellpadding="10" cellspacing="0" width="500">
          ...
          <tr>
            <td>
              Welcome to our community, you are now a MADer!
            </td>
          </tr>

          <tr>
            <td>
              MAD is your fun and innovative marketplace to discover, launch and meet your favourite musicians, artists and designers.
            </td>
          </tr>
                ...
                <tr>
                  <td>
                    <table cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="font-size: 19px !important;"><span style="font-weight: bold;">Discover</span> artists & their projects</td>
                      </tr>
                  ...
                  <td>
                    <table cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="font-size: 19px !important;"><span style="font-weight: bold;">Vote</span> for your favorite artists</td>
                      </tr>
                  ...
                  <td>
                    <table cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="font-size: 19px !important;"><span style="font-weight: bold;">Buy</span> artists creations</td>
                      </tr>
                      ...
                      <tr>
                        <td>
                          <a href="'.esc_url(home_url()).'/shop/"><img src="cid:cta3"/></a>
                        </td>
                      </tr>
                    </table>
                  </td>
